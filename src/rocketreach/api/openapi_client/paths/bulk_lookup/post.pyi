...
# body param
SchemaForRequestBodyApplicationJson = APIBulkLookupQuery
...
class BulkLookupCreate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def bulk_lookup_create(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        stream: bool = False,
    ...
    def bulk_lookup_create(
        ...
        return self._bulk_lookup_create_oapg(
            body=body,
