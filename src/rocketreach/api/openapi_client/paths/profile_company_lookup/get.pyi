...
SchemaFor200ResponseBodyApplicationJson = ProfileAPISerializerWithCompany
...
class BaseApi(api_client.Api):
    @typing.overload
    def _profile_company_lookup_read_oapg(
        self,
...
class ProfileCompanyLookupRead(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def profile_company_lookup_read(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def profile_company_lookup_read(
        ...
        return self._profile_company_lookup_read_oapg(
