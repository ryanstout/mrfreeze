...
request_query_ticker = api_client.QueryParameter(
    name="ticker",
    style=api_client.ParameterStyle.FORM,
    schema=TickerSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJson = CompanyAPI
...
class CompanyLookupRead(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def company_lookup_read(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def company_lookup_read(
        ...
        return self._company_lookup_read_oapg(
