...
class JobHistoryAPI(
    ...
    highest_level: MetaOapg.properties.highest_level
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["highest_level"]) -> MetaOapg.properties.highest_level: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["company_linkedin_url"]) -> MetaOapg.properties.company_linkedin_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sub_department"]) -> MetaOapg.properties.sub_department: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["company_name", "department", "title", "highest_level", "description", "last_updated", "start_date", "end_date", "company", "company_id", "company_linkedin_url", "sub_department", "is_current", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["highest_level"]) -> MetaOapg.properties.highest_level: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["company_linkedin_url"]) -> typing.Union[MetaOapg.properties.company_linkedin_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sub_department"]) -> typing.Union[MetaOapg.properties.sub_department, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["company_name", "department", "title", "highest_level", "description", "last_updated", "start_date", "end_date", "company", "company_id", "company_linkedin_url", "sub_department", "is_current", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        highest_level: typing.Union[MetaOapg.properties.highest_level, str, ],
        last_updated: typing.Union[MetaOapg.properties.last_updated, str, datetime, ],
        ...
        company_linkedin_url: typing.Union[MetaOapg.properties.company_linkedin_url, None, str, schemas.Unset] = schemas.unset,
        sub_department: typing.Union[MetaOapg.properties.sub_department, None, str, schemas.Unset] = schemas.unset,
        is_current: typing.Union[MetaOapg.properties.is_current, None, bool, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
