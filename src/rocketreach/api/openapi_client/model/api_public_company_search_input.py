...
class APIPublicCompanySearchInput(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def query() -> typing.Type['CompanyQuery']:
                return CompanyQuery
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["query"]) -> 'CompanyQuery': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["order_by"]) -> MetaOapg.properties.order_by: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["query", "start", "page_size", "order_by", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["query"]) -> 'CompanyQuery': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["order_by"]) -> typing.Union[MetaOapg.properties.order_by, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["query", "start", "page_size", "order_by", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        order_by: typing.Union[MetaOapg.properties.order_by, str, schemas.Unset] = schemas.unset,
