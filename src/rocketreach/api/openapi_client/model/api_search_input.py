...
class APISearchInput(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def query() -> typing.Type['PersonQuery']:
                return PersonQuery
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["query"]) -> 'PersonQuery': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["query"]) -> 'PersonQuery': ...
