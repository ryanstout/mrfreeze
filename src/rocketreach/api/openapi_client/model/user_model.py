...
class UserModel(
    ...
    class MetaOapg:
        required = {
            "lookup_credit_balance",
            "plan",
            "export_credit_balance",
        }
        ...
        class properties:
            ...
            def plan() -> typing.Type['Plan']:
                return Plan
            lookup_credit_balance = schemas.IntSchema
            export_credit_balance = schemas.IntSchema
            ...
            daily_api_limit = schemas.StrSchema
            __annotations__ = {
                "plan": plan,
                "lookup_credit_balance": lookup_credit_balance,
                "export_credit_balance": export_credit_balance,
                "id": id,
                ...
                "state": state,
                "api_key": api_key,
                "api_key_domain": api_key_domain,
                "lifetime_credits_spent": lifetime_credits_spent,
                "lifetime_api_num_calls": lifetime_api_num_calls,
                "daily_api_num_calls": daily_api_num_calls,
                "daily_api_limit": daily_api_limit,
            }
    
    lookup_credit_balance: MetaOapg.properties.lookup_credit_balance
    plan: 'Plan'
    export_credit_balance: MetaOapg.properties.export_credit_balance
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["plan"]) -> 'Plan': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lookup_credit_balance"]) -> MetaOapg.properties.lookup_credit_balance: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["export_credit_balance"]) -> MetaOapg.properties.export_credit_balance: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["api_key_domain"]) -> MetaOapg.properties.api_key_domain: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lifetime_credits_spent"]) -> MetaOapg.properties.lifetime_credits_spent: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lifetime_api_num_calls"]) -> MetaOapg.properties.lifetime_api_num_calls: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["daily_api_num_calls"]) -> MetaOapg.properties.daily_api_num_calls: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["daily_api_limit"]) -> MetaOapg.properties.daily_api_limit: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["plan", "lookup_credit_balance", "export_credit_balance", "id", "first_name", "last_name", "email", "state", "api_key", "api_key_domain", "lifetime_credits_spent", "lifetime_api_num_calls", "daily_api_num_calls", "daily_api_limit", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lookup_credit_balance"]) -> MetaOapg.properties.lookup_credit_balance: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["export_credit_balance"]) -> MetaOapg.properties.export_credit_balance: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["api_key_domain"]) -> typing.Union[MetaOapg.properties.api_key_domain, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lifetime_credits_spent"]) -> typing.Union[MetaOapg.properties.lifetime_credits_spent, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lifetime_api_num_calls"]) -> typing.Union[MetaOapg.properties.lifetime_api_num_calls, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["daily_api_num_calls"]) -> typing.Union[MetaOapg.properties.daily_api_num_calls, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["daily_api_limit"]) -> typing.Union[MetaOapg.properties.daily_api_limit, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plan", "lookup_credit_balance", "export_credit_balance", "id", "first_name", "last_name", "email", "state", "api_key", "api_key_domain", "lifetime_credits_spent", "lifetime_api_num_calls", "daily_api_num_calls", "daily_api_limit", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        lookup_credit_balance: typing.Union[MetaOapg.properties.lookup_credit_balance, decimal.Decimal, int, ],
        plan: 'Plan',
        export_credit_balance: typing.Union[MetaOapg.properties.export_credit_balance, decimal.Decimal, int, ],
        ...
        api_key_domain: typing.Union[MetaOapg.properties.api_key_domain, None, str, schemas.Unset] = schemas.unset,
        lifetime_credits_spent: typing.Union[MetaOapg.properties.lifetime_credits_spent, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        lifetime_api_num_calls: typing.Union[MetaOapg.properties.lifetime_api_num_calls, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        daily_api_num_calls: typing.Union[MetaOapg.properties.daily_api_num_calls, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        daily_api_limit: typing.Union[MetaOapg.properties.daily_api_limit, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
