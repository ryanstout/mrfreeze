...
class ProfilePhoneAPI(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            premium = schemas.BoolSchema
            last_checked = schemas.DateTimeSchema
            __annotations__ = {
                "number": number,
                "type": type,
                "validity": validity,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["last_checked"]) -> MetaOapg.properties.last_checked: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["number", "type", "validity", "recommended", "premium", "last_checked", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["last_checked"]) -> typing.Union[MetaOapg.properties.last_checked, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["number", "type", "validity", "recommended", "premium", "last_checked", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        premium: typing.Union[MetaOapg.properties.premium, bool, schemas.Unset] = schemas.unset,
        last_checked: typing.Union[MetaOapg.properties.last_checked, str, datetime, schemas.Unset] = schemas.unset,
