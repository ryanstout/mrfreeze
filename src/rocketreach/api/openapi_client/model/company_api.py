...
class CompanyAPI(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['CompanyAddress']:
            ...
            class industry(
                ...
                class MetaOapg:
                    min_length = 1
            rr_profile_url = schemas.StrSchema
            ...
            __annotations__ = {
                ...
                "revenue": revenue,
                "industry": industry,
                "rr_profile_url": rr_profile_url,
                "description": description,
            }
    
    sic_codes: MetaOapg.properties.sic_codes
    address: 'CompanyAddress'
    ticker_symbol: MetaOapg.properties.ticker_symbol
    num_employees: MetaOapg.properties.num_employees
    funding_investors: MetaOapg.properties.funding_investors
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ticker_symbol"]) -> MetaOapg.properties.ticker_symbol: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'CompanyAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["num_employees"]) -> MetaOapg.properties.num_employees: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["funding_investors"]) -> MetaOapg.properties.funding_investors: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["website_domain"]) -> MetaOapg.properties.website_domain: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> MetaOapg.properties.links: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["year_founded"]) -> MetaOapg.properties.year_founded: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rr_profile_url"]) -> MetaOapg.properties.rr_profile_url: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ticker_symbol", "address", "num_employees", "funding_investors", "sic_codes", "id", "name", "domain", "email_domain", "website_domain", "links", "year_founded", "phone", "fax", "revenue", "industry", "rr_profile_url", "description", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> 'CompanyAddress': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["num_employees"]) -> MetaOapg.properties.num_employees: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["funding_investors"]) -> MetaOapg.properties.funding_investors: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sic_codes"]) -> MetaOapg.properties.sic_codes: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["website_domain"]) -> typing.Union[MetaOapg.properties.website_domain, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union[MetaOapg.properties.links, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["year_founded"]) -> typing.Union[MetaOapg.properties.year_founded, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rr_profile_url"]) -> typing.Union[MetaOapg.properties.rr_profile_url, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ticker_symbol", "address", "num_employees", "funding_investors", "sic_codes", "id", "name", "domain", "email_domain", "website_domain", "links", "year_founded", "phone", "fax", "revenue", "industry", "rr_profile_url", "description", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        sic_codes: typing.Union[MetaOapg.properties.sic_codes, list, tuple, ],
        address: 'CompanyAddress',
        ticker_symbol: typing.Union[MetaOapg.properties.ticker_symbol, None, str, ],
        num_employees: typing.Union[MetaOapg.properties.num_employees, None, decimal.Decimal, int, ],
        funding_investors: typing.Union[MetaOapg.properties.funding_investors, list, tuple, ],
        ...
        website_domain: typing.Union[MetaOapg.properties.website_domain, None, str, schemas.Unset] = schemas.unset,
        links: typing.Union[MetaOapg.properties.links, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        year_founded: typing.Union[MetaOapg.properties.year_founded, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        rr_profile_url: typing.Union[MetaOapg.properties.rr_profile_url, str, schemas.Unset] = schemas.unset,
