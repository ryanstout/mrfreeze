...
class ProfileAPI(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_employer_domain", "current_employer_website", "job_history", "education", "skills", "current_employer_id", "current_employer_linkedin_url", "region_latitude", "region_longitude", "profile_list", "id", "status", "name", "profile_pic", "linkedin_url", "links", "location", "current_title", "normalized_title", "current_employer", "emails", "phones", "birth_year", "recommended_email", "recommended_personal_email", "recommended_professional_email", "current_work_email", "current_personal_email", "city", "region", "country", "country_code", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
